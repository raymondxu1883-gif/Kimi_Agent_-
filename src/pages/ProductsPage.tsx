...
import { Eye, Heart, ArrowRight, Search, ChevronRight } from 'lucide-react';
    ...
    <section id="products" ref={sectionRef} className="py-24 bg-ivory">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 mb-8">
          <a href="/" className="text-gray-600 hover:text-gold transition-colors">Home</a>
          <ChevronRight className="w-4 h-4 text-gray-400" />
          <span className="text-gold font-medium">Products</span>
        </div>
